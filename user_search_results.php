...
<?php
    ...
    // Check if search query parameter is set in the URL
    if(isset($_GET['search_query'])) {
        // Assign the value of search query parameter to $search_query
        $_SESSION['search_query'] = $_GET['search_query']; // Store search query in session
        $search_query = $_SESSION['search_query'];
    } elseif (isset($_SESSION['search_query'])) {
        // Retrieve search query from session if not set in URL
        $search_query = $_SESSION['search_query'];
    }
    ...
    // Build the SQL query based on filters and search query (product name)
    ...
    if (!empty($priceFilter)) {
        ...
        $sql = "SELECT sno, product_name, seller_name, product_detail, product_price, product_image,product_qty, product_color, product_size 
                FROM product 
    ...
    if (!empty($colorFilter)) {
        ...
        FROM product 
        WHERE (product_name LIKE '$search_query' AND product_color = '$colorFilter')";
    ...
    if (!empty($sizeFilter)) {
        ...
        $sql = "SELECT sno, product_name, seller_name, product_detail, product_price, product_qty,product_image, product_color, product_size 
        FROM product 
        WHERE (product_name LIKE '%$search_query' AND product_size = '$sizeFilter')";
    ...
    // Check if the Add to Wishlist form is submitted
        if (isset($_POST['wishlistButton'])) {
            ...
            if (isset($_SESSION['login_user'])) {
                ...
                $check_stmt->bind_param("sss", $user_name, $product_name, $product_price); // Change 'si' to 'sss'
                $check_stmt->execute();
                $check_result = $check_stmt->get_result();
             ...
             <div class="bg-dark p-2">
                    ...
                    <div class="price-filter text-bg-dark ">
                        ...
                        <form id="priceFilterForm" action="" method="GET">
                            ...
                            <input type="hidden" name="imageId" value="<?php echo htmlspecialchars($search_query); ?>">
                        </form>
                    </div>
        ...
        <div class="container ">
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4  mt-3" style="overflow-y: auto; max-height: 90vh; -ms-overflow-style: none; scrollbar-width: none;">
                ...
                <div class="card">
                    ...
                    <img src="<?php echo htmlspecialchars($row['product_image']); ?>" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            ...
                            <?php if ($max_quantity == 0) {
                                ...
                                echo "<div class='btn-group mt-4' role='group' aria-label='Add to Cart or Wishlist'>";
