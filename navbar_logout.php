...
<body>
    <div class="mt-2 container-fluid d-flex flex-column flex-sm-row bg-transparent">
        ...
        <span id="product-item" class="col-sm-5 d-none d-sm-flex justify-content-around align-self-sm-center">
            <a  onclick="showAlert()" class="nav-link noteButton">MEN</a>
            <a  onclick="showAlert()" class="nav-link noteButton">WOMEN</a>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a  onclick="showAlert()" class="dropdown-item noteButton">BOYS'</a></li>
                    <li><a  onclick="showAlert()" class="dropdown-item noteButton">GIRLS</a></li>
                </ul>
            </div>
            <a  onclick="showAlert()" class="nav-link noteButton">TOP BRAND</a>
        </span>
